        ...
        <div className="w-full max-w-md">
          ...
          {step === 1 ? (
            ...
            <div className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${
                      form.role === r.value ? 'border-[#446900]' : 'border-[#d1d5db]'
                    }`}>
                      {form.role === r.value && (
                        <div className="w-2.5 h-2.5 rounded-full bg-[#446900]" />
                      )}
                    </div>
                    <div>
              ...
              <button
                onClick={() => setStep(2)}
                className="w-full bg-[#a3e635] hover:bg-[#bef264] text-[#0b1c30] font-bold py-3.5 rounded-2xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-[#a3e635]/30 mt-6 text-base"
              >
              ...
              <button
                onClick={() => googleLogin()}
                className="w-full flex items-center justify-center gap-3 border-2 border-[#e5e7eb] rounded-2xl py-3 px-6 font-semibold text-[#1f2937] hover:bg-[#f3f4f6] transition-all bg-white text-sm"
              >
            ...
            <form onSubmit={(e) => { e.preventDefault(); registerMutation.mutate() }} className="space-y-4">
              ...
              <Input
                ...
                required
                className="!bg-white !border-[#e5e7eb] !text-[#1f2937] focus:!border-[#446900] rounded-xl"
              />
              <Input
                label="Email"
                type="email"
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 bottom-2.5 text-[#9ca3af] hover:text-[#446900]"
                >
              ...
              <button
                ...
                className="w-full bg-[#a3e635] hover:bg-[#bef264] text-[#0b1c30] font-bold py-3.5 rounded-2xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-[#a3e635]/30 disabled:opacity-60 disabled:cursor-not-allowed text-base mt-2"
              >
